...
def generate_result_script(scripts_dir, identifier_suffix):
    ...
    for domain, config in sorted_domains:
        ...
        result_script_content += f'python data/evaluators/CL-evaluators/eval_all.py --result-dir working/llava-1.5-7b/full-sft-cl-align-projector{"-" + identifier_suffix if identifier_suffix else ""}/{domain}\n'
