...
def generate_result_script(scripts_dir, identifier_suffix):
    ...
    for domain, config in sorted_domains:
        ...
        result_script_content += f'python data/evaluators/CL-evaluators/eval_all_orginal.py --result-dir working/llava-1.5-7b/lora-sft-cl-replay-align-projector{"-" + identifier_suffix if identifier_suffix else ""}/{domain}\n'
