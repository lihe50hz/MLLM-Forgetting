...
def main():
    parser = argparse.ArgumentParser(description="Turn Caltech-101 into a VQA dataset (JSON format).")
    parser.add_argument(
        "--caltech_jsonl",
        type=str,
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/pasteur2/u/lihe50hz/caltech101-vqa-json",
    ...
    for i, sample in progress_bar: # type: ignore
        try:
            ...
            question = "<image>\nWhat is the object category in this image? Please answer with a single letter (A, B, C or D).\n"
