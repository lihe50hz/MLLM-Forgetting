...
def process_textvqa_split(root_dir: str, split: str, output_format: str = "json") -> None:
    """
    Process TextVQA data for a specific split.
...
def process_textvqa_dataset(root_dir: str, splits: List[str] = None, output_format: str = "json") -> None:
    """
    Process TextVQA dataset for multiple splits.
    ...
    for split in splits:
        try:
            process_textvqa_split(root_dir, split, output_format)
        except Exception as e:
...
def main():
    parser = argparse.ArgumentParser(description="Process TextVQA dataset from parquet files to JSON format.")
    parser.add_argument(
        "--root_dir",
        type=str,
        required=True,
    ...
    print(f"Processing TextVQA dataset from: {args.root_dir}")
    print(f"Data directory: {data_dir}")
    print(f"Output format: {args.output_format}")
    
    process_textvqa_dataset(args.root_dir, args.splits, args.output_format)
    
    print("\nTextVQA processing complete!")
