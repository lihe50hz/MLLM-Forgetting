...
def process_pathvqa_split(root_dir: str, split: str, output_format: str = "json") -> None:
    """
    Process PathVQA data for a specific split.
...
def process_pathvqa_dataset(root_dir: str, splits: List[str] = None, output_format: str = "json") -> None:
    """
    Process PathVQA dataset for multiple splits.
    ...
    for split in splits:
        try:
            process_pathvqa_split(root_dir, split, output_format)
        except Exception as e:
...
def main():
    parser = argparse.ArgumentParser(description="Process PathVQA dataset from parquet files to JSON format.")
    parser.add_argument(
        "--root_dir",
        type=str,
        required=True,
    ...
    print(f"Processing PathVQA dataset from: {args.root_dir}")
    print(f"Data directory: {data_dir}")
    print(f"Output format: {args.output_format}")
    
    process_pathvqa_dataset(args.root_dir, args.splits, args.output_format)
    
    print("\nPathVQA processing complete!")
