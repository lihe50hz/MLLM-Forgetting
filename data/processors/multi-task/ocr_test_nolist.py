...
def append_image_token_to_text(json_file_path: str, output_file_path: str = None) -> List[Dict[str, Any]]:
    ...
    # Process each sample
    for sample in data:
        if 'answer' in sample and isinstance(sample['answer'], list):
            # Turn list into string with just comma separated
...
if __name__ == "__main__":
    ...
    input_file = "/pasteur2/u/lihe50hz/MLLM-CL/OCR_test/test_with_token.json"
    output_file = "/pasteur2/u/lihe50hz/MLLM-CL/OCR_test/test_with_token_nolist.json"
