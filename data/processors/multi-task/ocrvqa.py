...
def process_ocrvqa_split(root_dir: str, split: str, output_format: str = "json") -> None:
    """
    Process OCRVQA data for a specific split.
    ...
    required_columns = ["image", "questions", "answers"]
...
def process_ocrvqa_dataset(root_dir: str, splits: List[str] = None, output_format: str = "json") -> None:
    """
    Process OCRVQA dataset for multiple splits.
    ...
    for split in splits:
        try:
            process_ocrvqa_split(root_dir, split, output_format)
        except Exception as e:
...
def main():
    parser = argparse.ArgumentParser(description="Process OCRVQA dataset from parquet files to JSON format.")
    parser.add_argument(
        "--root_dir",
        type=str,
        required=True,
    ...
    print(f"Processing OCRVQA dataset from: {args.root_dir}")
    print(f"Data directory: {data_dir}")
    print(f"Output format: {args.output_format}")
    
    process_ocrvqa_dataset(args.root_dir, args.splits, args.output_format)
    
    print("\nOCRVQA processing complete!")
