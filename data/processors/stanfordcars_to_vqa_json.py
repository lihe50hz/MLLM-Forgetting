...
def main():
    parser = argparse.ArgumentParser(description="Turn Stanford Cars into a VQA dataset (JSON format).")
    parser.add_argument(
        "--cars_jsonl",
        type=str,
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/pasteur2/u/lihe50hz/stanfordcars-vqa-json",
    ...
    for i, sample in progress_bar: # type: ignore
        try:
            ...
            question = "<image>\nWhat is the make and model of the car in this image? Please answer with a single letter (A, B, C or D).\n"
