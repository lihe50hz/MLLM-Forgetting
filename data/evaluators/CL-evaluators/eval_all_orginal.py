...
def eval_all(result_dir):
    ...
    for subfolder in subfolders:
        ...
        if subfolder == "RS" or subfolder == "AD":
            ai2d.eval_single_original(result_file, output_dir, prefix=subfolder)
        elif subfolder == "Med":
            pvqa.eval_single_original(result_file, output_dir, prefix=subfolder)
        elif subfolder == "Sci":
            sci.eval_single_original(result_file, output_dir, prefix=subfolder)
        elif subfolder == "Fin":
            finvis.eval_single_original(result_file, output_dir, prefix=subfolder)
        else:
